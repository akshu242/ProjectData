...
//add policy details	
	@Override
	public PolicyDetails addPolicy(Integer custId , PolicyDetails po) {
		int i= custId;
		PolicyHolder p = sf.getCurrentSession().get(PolicyHolder.class, i);
		po.setPolicyHolderForPolicies(p);
