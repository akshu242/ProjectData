...
/*	@DeleteMapping("/{policyHolderId}")
	...
	*/
	...
	@PutMapping(value="/update/{policyHolderId}",consumes= "application/json",produces = "application/json")
	public ResponseEntity<?> update(@PathVariable int policyHolderId,@RequestBody PolicyHolder policyHolder){
